...
import com.test.comm.util.algorithmImpl.BCConvert;
import com.test.comm.util.algorithmImpl.StringImpl;
...
public final class StringUtil {
	 ...
	 * @return
	 */
	public static String captureLast(String url) {
